...
\section{Paso 5: Diseñar tabla tipo\_cambio\_raw}
...
\section{Paso 6: Diseñar tabla balance\_bancario\_raw}
...
\item[$\Box$] Tabla \texttt{tipo\_cambio\_raw} creada.
\item[$\Box$] Tabla \texttt{balance\_bancario\_raw} creada.
\item[$\Box$] Scripts SQL almacenados en la carpeta \texttt{sql}.
